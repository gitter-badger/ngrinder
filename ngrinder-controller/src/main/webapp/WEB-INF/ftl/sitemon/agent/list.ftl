...
<#include "../../common/datatables.ftl"/>
	<title><@spring.message "siteMon.agent.list.title"/></title>
</head>
<body>
<div id="wrap">
...
<div class="container">
	<fieldSet>
		<legend class="header"> <@spring.message "siteMon.agent.list.title"/> </legend>
	</fieldSet>
	...
	<table class="table table-striped table-bordered ellipsis" id="agent_table">
		...
		<tr>
			...
			<th><@spring.message "siteMon.agent.list.maxCpu"/></th>
			<th><@spring.message "siteMon.agent.list.minMem"/></th>
			<th><@spring.message "siteMon.agent.list.maxTime"/></th>
			<th><@spring.message "siteMon.agent.list.registScript"/></th>
		</tr>
		</thead>
		<tbody>
